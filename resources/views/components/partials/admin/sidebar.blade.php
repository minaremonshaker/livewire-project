<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    <!-- Dashboard -->
    <li @class(['menu-item','active'=> Route::currentRouteName() === "admin.dashboard" ])>
    ...
    <!-- Settings -->
    <li @class(['menu-item','active'=> Route::currentRouteName() === "admin.settings" ])>
    ...
    <!-- Skills -->
    <li @class(['menu-item','active'=> Route::currentRouteName() === "admin.skills" ])>
    ...
    <!-- Subscribers -->
    <li @class(['menu-item','active'=> Route::currentRouteName() === "admin.subscriber" ])>
    ...
    <!-- Counter -->
    <li @class(['menu-item','active'=> Route::currentRouteName() === "admin.counter" ])>
    ...
    <!-- Services -->
    <li @class(['menu-item','active'=> Route::currentRouteName() === "admin.service" ])>
    ...
    <!-- Messages -->
    <li @class(['menu-item','active'=> Route::currentRouteName() === "admin.message" ])>
    ...
    <!-- Categories -->
    <li @class(['menu-item','active'=> Route::currentRouteName() === "admin.categories" ])>
